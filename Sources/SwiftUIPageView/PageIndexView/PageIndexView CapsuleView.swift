...
extension PageIndexView {
    ...
    struct CapsuleView<PageIndexViewContent: View>: View {
...
extension PageIndexView.CapsuleView {
    ...
    static func endCapPadding(dotSize: CGFloat, spacing: CGFloat, scaling: CGFloat) -> CGFloat {
    ...
    static func thicknessPadding(dotSize: CGFloat, scaling: CGFloat) -> CGFloat {
        dotSize * scaling
    }
}
